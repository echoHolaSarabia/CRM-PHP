...
$query = "SELECT n.id,n.tags, n.antetitulo,n.antetitulo_alt, n.titulo,n.titular_alt,img_cuadrada,n.entradilla,n.entradilla_alt FROM noticias n WHERE n.seccion = 151  AND n.activo=1 AND n.fecha_publicacion < now() ".$ids." ORDER BY n.fecha_publicacion DESC LIMIT 3 ";
