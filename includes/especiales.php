...
$query = "SELECT n.id,n.tags, n.antetitulo,n.antetitulo_alt, n.titulo,n.titular_alt,img_cuadrada,n.entradilla,n.entradilla_alt FROM noticias n WHERE n.seccion = 7  AND n.activo=1 AND n.fecha_publicacion < now() ".$ids." ORDER BY n.fecha_publicacion DESC LIMIT 3 ";
...
<div class="iBckTitPart">
        <div class="iTitPart">
            <div class="iTxtTitPart">Especiales</div>
            <div class="iPuntaPart"><img src="sitefiles/img/puntaTitRotador.jpg" width="21" alt="" /></div>
            <div class="iVerMas"><a href="/especiales">ver mas</a></div>
        </div>
    </div>

    <? 
	while ($noticia = mysql_fetch_assoc($r)) {
		$noticia["nombre_seccion"] = "especiales";
