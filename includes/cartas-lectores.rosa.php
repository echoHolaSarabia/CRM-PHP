...
$query = "SELECT n.id,n.tags, n.antetitulo,n.antetitulo_alt, n.titulo,n.titular_alt,img_cuadrada,n.entradilla,n.entradilla_alt FROM noticias n WHERE n.seccion = 8  AND n.activo=1 AND n.fecha_publicacion < now() ".$ids." ORDER BY n.fecha_publicacion DESC LIMIT 3 ";
...
<div class="iBckTitPart">
        <div class="iTitPart">
            <div class="iTxtTitPart">cartas de los lectores</div>
            <div class="iPuntaPart"><img src="sitefiles/img/puntaTitRotador.jpg" width="21" alt="" /></div>
            <div class="iVerMas"><a href="/cartas-de-los-lectores">ver mas</a></div>
        </div>
    </div>
