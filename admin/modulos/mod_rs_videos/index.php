...
$categorias = $funciones -> get_videos($palabra,$page,$items,$orden,$tipo_orden,$desde,$hasta);
$num_categorias = $funciones -> get_num_videos($palabra,$desde,$hasta);
?>
<script>
function eliminar_videos(){
	if (confirm("¿Desea eliminar los videos seleccionados?"))
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <td class="botonera" align="right">
          	<table border="0" cellpadding="0" cellspacing="0" >
      		  <tr>
                <td class="botones_botonera"><a href="javascript:eliminar_videos();" class="enlaces_botones_botonera"><img src="images/eliminar.png" border="0"><br />Borrar</a></td>
              </tr>
            </table>
          </td>
        </tr>
