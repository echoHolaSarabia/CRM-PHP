                    ...
                    <tr>
                      ...
                      <td>
                        <select name="fuente" style="width:254px" onchange="cambiar_fuente(this.value)" >
                          ...
                          <option value="codigo" <?=(isset($banner) && $banner["fuente"]=="codigo") ? "SELECTED" : ""?>>Código</option>
                        </select>               
                      </td>
                    </tr>
                    <tr>
...
<!--                        <div id="capa_megabanner" style="display:<?=(!(isset($banner) && $banner["tipo"]=="Recomendado")) ? "inline" : "none"?>">(Tamaño recomendado 460x90)</div>-->
                        <div id="capa_megabanner" style="display:<?=(!(isset($banner) && $banner["tipo"]=="Recomendado")) ? "inline" : "none"?>">(Ancho recomendado 300)</div>
<!--                        <div id="capa_recomendado" style="display:<?=(isset($banner) && $banner["tipo"]=="Recomendado") ? "inline" : "none"?>">(Tamaño recomendado 60x55)</div>-->
                      </td>
                      <td>            
                      <?
