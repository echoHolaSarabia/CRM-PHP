...
if (isset($_GET['tipo']) && $_GET['tipo'] != ""){
	...
	//Nos quedamos con el nombre de la foto ej: foto.jpg --> $imagen = foto
	$imagen = substr($_GET['foto'],0,strripos($_GET['foto'], '.'));
	
	//Nombre final de la imagen ej: $imagen = foto; $tipo = rotador; $extension = jpg;  foto_rotador.jpg
