...
$delta = mysql_query("SELECT id_elemento FROM planillas_elementos where id_elemento = '$id' and id_planilla = '$planilla'");
	 

  while( $array_datos = mysql_fetch_row($delta) ){
    
    foreach ( $array_datos as $passwo3 ){
