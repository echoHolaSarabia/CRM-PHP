<?php
/*
ESPACIO A�ADIDO PARA ELIMINAR EL LOGIN DE TINY_MCE
*/
session_start();
...
header("location: " . htmlentities($_REQUEST['return_url']));
exit;
/*
FIN ESPACIO A�ADIDO PARA ELIMINAR EL LOGIN DE TINY_MCE
*/

	// Some settings
	$msg = "";
	$username = "demo";
	$password = "demo01"; // Change the password to something suitable
