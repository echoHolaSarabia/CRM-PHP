...
*/
 if (!EMAILTEXTCREDITS) {
$html["signature"] = "";
# oops, accidentally became spyware, never intended that, so take it out again <img src="http://i0.wp.com/blog.vermiip.es/wp-includes/images/smilies/icon_smile.gif?w=625" alt=":-)" class="wp-smiley" width="15" height="15"> 
$html["signature"] = "";
} else {
$html["signature"] = "";
}
