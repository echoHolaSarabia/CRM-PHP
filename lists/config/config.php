...
$database_name = "newsletter_phplist";

# what user has access to this database
$database_user = "sohosisi";

# and what is the password to login to control the database
$database_password = 's8934s8934';
...
$message_envelope = 'rebotes@padelspain.net';
...
$bounce_mailbox_user = 'rebotes@padelspain.net';
$bounce_mailbox_password = 's8934s8934';
